...
public class MealPlannerApp {
    ...
    public static void main(String[] args) {
        ...
        Recipe orangeSnack = Recipe.create("Orange snack");
        orangeSnack.addIngredient(orange, 1);

        Recipe pearSnack = Recipe.create("Pear snack");
        pearSnack.addIngredient(pear, 1);

        Recipe bananaSnack = Recipe.create("Banana snack");
        bananaSnack.addIngredient(banana, 1);

        Recipe bananaY = Recipe.create("Greek yoghurt and fruit");
        ...
        Recipe cousVeg = Recipe.create("Cous cous with vegetables");
        ...
        Recipe coldSalad = Recipe.create("Cold salad");
        ...
        for (DayOfWeek day : DayOfWeek.values()) {
            for (MealType type : MealType.values()) {
                ...
                boolean assigned = plan.assignRecipeAuto(day, type, recipe);
                if (!assigned) {
        ...
        Map<Ingredient, Double> items = globalShoppingList.getItems(); // assumo che tu abbia questo metodo
